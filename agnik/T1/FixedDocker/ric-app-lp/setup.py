...
setup(
    ...
    install_requires=["ricxappframe>=1.1.1,<2.0.0", "p5py", "PEP517", "Cython", "numpy >= 1.16.2", "pandas>=1.1.3", "torch>=2.2.0", "torchvision>=0.17.0", "torchaudio>=2.2.0", "influxdb", "schedule>=0.0.0"],

# depriclatest - Near-RT RIC Kubernetes Operator

> **⚠️ EXPERIMENTAL**: This operator is currently experimental and not integrated into the main Near-RT RIC deployment flow. Use the standard Helm-based deployment (`bin/deploy-nearrtric.sh`) for production deployments.
...
- **Compatibility**: Works with Kubernetes 1.27+ and modern container runtimes (containerd)
- **Integration**: Not currently integrated into main deployment scripts
- **Documentation**: Incomplete (see TODO comments)
- **Recommendation**: Use for experimentation only. Production deployments should use Helm-based installation.
